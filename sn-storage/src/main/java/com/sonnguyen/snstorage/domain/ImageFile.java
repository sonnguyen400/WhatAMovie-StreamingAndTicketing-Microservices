...
public class ImageFile extends File {
    ...
    public ImageFile(MultipartFile fileData, ImageUploadCmd cmd, StorageProvider provider) {
    ...
    public FileVariantCmd extractDefaultVariantFromFile(MultipartFile fileData) {
        ...
        try (InputStream inputStream = fileData.getInputStream()) {
            ...
            imageMetadata.setWidth(bimg.getWidth());
            imageMetadata.setHeight(bimg.getHeight());
        } catch (Exception e) {
